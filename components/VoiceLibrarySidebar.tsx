...
const VoiceLibrarySidebar: React.FC<Props> = ({ isOpen, onClose, onSelectVoice, currentVoiceId }) => {
                    ...
                    <div className="flex-1 overflow-y-auto p-4 space-y-3">
                        {loading ? (
                            ...
                            filteredVoices.map(voice => (
                                <div
                                    key={voice.voice_id}
                                    className={`p-4 rounded-xl border transition-all ${currentVoiceId === voice.voice_id
